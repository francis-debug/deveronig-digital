    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center gap-2 px-4 py-3 sm:gap-3 md:gap-6 md:py-4">
        ...
        <nav className="ml-auto flex items-center gap-1 sm:ml-0">
          <IconBtn to="/" icon={<User className="h-5 w-5" />} label="Account" hideLabelMobile />
          <IconBtn to="/" icon={<Heart className="h-5 w-5" />} label="Wishlist" hideLabelMobile />
          <IconBtn to="/cart" icon={<ShoppingCart className="h-5 w-5" />} label="Cart" badge={count} />
        </nav>
      </div>

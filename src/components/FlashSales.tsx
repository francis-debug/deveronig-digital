...
export function FlashSales() {
  ...
  return (
    <section>
      <div className="mb-4 flex items-center justify-between gap-3 bg-gradient-to-r from-discount to-[#c2410c] px-4 py-3 text-white">
        ...
        <Link href="/categories" className="shrink-0 text-xs font-semibold underline-offset-2 hover:underline sm:text-sm">
          See All →
        </Link>
      </div>

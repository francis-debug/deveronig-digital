...
function CartProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx.Provider, { value: { items, count, subtotal, add, remove, setQty, clear }, children });
}
function useCart() {
...
const appCss = "/assets/styles-BkcDYrk0.css";
...
const Route$6 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Deveronig Digital Electronics — Kenya's One Stop Electronics Store" },
      { name: "description", content: "Shop genuine electronics & appliances in Kenya. TVs, fridges, cookers, solar, CCTV, smartphones. Fast delivery, pay on delivery." }
    ],
...
const $$splitComponentImporter$5 = () => import("./checkout--Tvy_rnq.js");
const Route$5 = createFileRoute("/checkout")({
  head: () => ({
    meta: [{
      title: "Checkout — Deveronig"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./categories-BSDH0aAw.js");
const Route$4 = createFileRoute("/categories")({
  head: () => ({
    meta: [{
      title: "All Categories — Deveronig Digital Electronics"
    }, {
      name: "description",
      content: "Browse all electronics & appliances categories at Deveronig Kenya."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./cart-DTk4qn5M.js");
const Route$3 = createFileRoute("/cart")({
  head: () => ({
    meta: [{
      title: "Your Cart — Deveronig"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-CZqZ36W7.js");
...
const PRODUCTS = [
  ...
  { id: "p2", title: "Von 4-Burner Gas Cooker with Oven", price: 45500, oldPrice: 58e3, image: img("1556909114-f6e7ad7d3136"), rating: 4.7, reviews: 132, category: "kitchen-appliances", brand: "Von" },
  { id: "p3", title: "Ramtons 200L Double Door Refrigerator", price: 38900, oldPrice: 47e3, image: img("1571175443880-49e1d25b2bc5"), rating: 4.5, reviews: 98, category: "home-appliances", brand: "Ramtons" },
  { id: "p4", title: "Bruhm 7kg Front Load Washing Machine", price: 52400, oldPrice: 65e3, image: img("1626806787461-102c1bfaaea1"), rating: 4.4, reviews: 76, category: "home-appliances", brand: "Bruhm" },
  { id: "p5", title: "Solar 300W Mono Crystalline Panel", price: 18500, oldPrice: 22e3, image: img("1509391366360-2e959784a276"), rating: 4.8, reviews: 56, category: "solar-systems" },
  { id: "p6", title: "Hikvision 4-Channel CCTV Kit + DVR", price: 24900, oldPrice: 32e3, image: img("1558002038-1055907df827"), rating: 4.6, reviews: 189, category: "security-systems", brand: "Hikvision" },
  { id: "p7", title: "JBL Bluetooth Wireless Soundbar 2.1", price: 15900, oldPrice: 21e3, image: img("1545454675-3531b543be5d"), rating: 4.7, reviews: 312, category: "audio", brand: "JBL" },
  { id: "p8", title: "Inverter 3000W Pure Sine Wave Power", price: 27500, oldPrice: 34e3, image: img("1620283085439-39620a1e21c4"), rating: 4.5, reviews: 64, category: "power-backup" },
  { id: "p9", title: "Mika 2.5HP Treadmill with Bluetooth", price: 78900, oldPrice: 95e3, image: img("1534438327276-14e5300c3a48"), rating: 4.6, reviews: 41, category: "gym-equipment", brand: "Mika" },
  ...
  { id: "p14", title: "LG 1.5HP Split Air Conditioner Inverter", price: 58500, oldPrice: 68e3, image: img("1631545806609-25fd2bb01865"), rating: 4.6, reviews: 92, category: "cooling-heating", brand: "LG" },
  { id: "p15", title: "HP LaserJet Pro M404 Mono Printer", price: 28500, oldPrice: 33e3, image: img("1497366216548-37526070297c"), rating: 4.5, reviews: 73, category: "office-equipment", brand: "HP" },
  ...
  { id: "p17", title: 'Mountain Bike 26" 21-Speed Aluminium', price: 22500, oldPrice: 28e3, image: img("1571068316344-75bc76f77890"), rating: 4.6, reviews: 51, category: "bikes-ride-ons" },
  ...
  { id: "p22", title: 'Karaoke System 8" with 2 Mics', price: 18900, oldPrice: 24e3, image: img("1545454675-3531b543be5d"), rating: 4.5, reviews: 65, category: "audio" },
...
const WHATSAPP_NUMBER = "254712407941";
const PHONE_DISPLAY = "0712 407 941";
const $$splitComponentImporter$1 = () => import("./product._id-CgtRm3yK.js");
const $$splitErrorComponentImporter$1 = () => import("./product._id-BFQVqvRZ.js");
const $$splitNotFoundComponentImporter$1 = () => import("./product._id-CAVJ50LS.js");
const Route$1 = createFileRoute("/product/$id")({
  ...
  head: ({
    ...
    meta: [{
      title: `${loaderData?.product.title ?? "Product"} — Deveronig`
    }, {
      name: "description",
...
const $$splitComponentImporter = () => import("./category._slug-CZbBEjx0.js");
const $$splitErrorComponentImporter = () => import("./category._slug-CYQPJdmC.js");
const $$splitNotFoundComponentImporter = () => import("./category._slug-auu8hVjz.js");
const Route2 = createFileRoute("/category/$slug")({
  loader: ({
    params
  }) => {
  ...
  head: ({
    ...
    meta: [{
      ...
      name: "description",
      content: `Shop ${loaderData?.cat.name ?? ""} at Deveronig Kenya. Genuine products, fast delivery.`
    }]
  }),
...
const CategorySlugRoute = Route2.update({
  id: "/category/$slug",
  path: "/category/$slug",
  getParentRoute: () => Route$6
});
